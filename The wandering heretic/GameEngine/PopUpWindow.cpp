...
/// <summary>
/// renders the background and the button exit if it's not null
/// it also checks if the button exit was pressed
/// if yes then it cloeses the tab
/// </summary>
...
/// however if the button is null then it does nothing
/// </summary>
